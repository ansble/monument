...
test('should add a verb if the route already exists', t => {
  ...
  t.is(routeStore.add('/this/is/a/test', 'post').standard['/this/is/a/test'].length, 2);

  t.is(routeStore.add('/this/is/a/test', 'post').standard['/this/is/a/test'][0], 'get');

  t.is(routeStore.add('/this/is/a/test', 'post').standard['/this/is/a/test'][1], 'post');

  t.is(routeStore.add('/this/is/a/test', ['put', 'report']).standard['/this/is/a/test'].length, 4);

  t.is(routeStore.add('/this/is/a/test', ['put', 'report']).standard['/this/is/a/test'][0], 'get');

  t.is(routeStore.add('/this/is/a/test', ['put', 'report']).standard['/this/is/a/test'][1], 'post');

  t.is(routeStore.add('/this/is/a/test', ['put', 'report']).standard['/this/is/a/test'][2], 'put');

  t.is(routeStore.add('/this/is/a/test', ['put', 'report']).standard['/this/is/a/test'][3], 'report');
});
...
test('should do nothing if there is no change', t => {
  ...
  t.is(routeStore.add('/this/is/a/test', 'get').standard['/this/is/a/test'].length, 1);
});